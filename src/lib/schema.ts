...
export function softwareApplicationSchema() {
  return {
    ...
    url: SITE.url,
    inLanguage: SITE.locale,
    softwareVersion: SITE.downloads.macOS.version,
    ...
    featureList: [
      ...
      "Captura local de áudio e tela no macOS",
      "Compatível com Macs Apple Silicon e Intel",
    ],
    publisher: { "@id": `${SITE.url}/#organization` },
    offers: {
      "@type": "Offer",
      ...
      url: `${SITE.url}${SITE.downloads.macOS.landingPath}`,
    },
  } as const;
}
